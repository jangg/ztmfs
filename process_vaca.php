...
//  	echo 'Het is een robot!!!!!!';
	...
	header ('location: vacatures.php#vacatureform');
	exit();
} else {
...
$email_subject = "Website sollicitatieformulier:  $name";
$email_body = "Je hebt een sollicitatie email van Het Zoetermeerfonds.nl ontvangen.\n\n"."Hier zijn de details:\n\nNaam: $name\n\nEmail: $email_address\n\nTelefoon: $phone\n\nBericht:\n$message";

$headers = "From: info@zoetermeerfonds.nl\n"; 
$headers .= "Reply-To: $email_address";	
mail($to,$email_subject,$email_body,$headers);
$email_body = "Je hebt een sollicitatie email naar Het Zoetermeerfonds verstuurd.\n\n"."Hier zijn de details:\n\nNaam: $name\n\nEmail: $email_address\n\nTelefoon: $phone\n\nBericht:\n$message";
mail($email_address,$email_subject,$email_body,$headers);
	$data['message'] = "Je sollicitatiegegevens zijn naar het Zoetermeerfonds verzonden.";
$data['success'] = TRUE;	   
